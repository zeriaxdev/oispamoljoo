...
# ^ the message above is utter bullshit, everything is working.
...
path_overrides: Dict[str, str] = {
    "./snd/none/none": "./snd/none/none0.ogg",
    "./snd/open/open": "./snd/open/open0.ogg"
}


urls = [f"oispa.ml/{x}" for x in asset_folders]
files = []
...
for missing, url_file, url_file_loc in sorted(file_not_found):
    print(
        YELLOW + f"'{missing}' is missing! Located at: \"{url_file}:{url_file_loc[0]}:{url_file_loc[1]}\"" + RESET)
